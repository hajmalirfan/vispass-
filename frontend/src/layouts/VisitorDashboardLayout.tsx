...
const navItems = [
  { to: '/dashboard/visitor', label: 'Available Events', icon: CalendarDays, end: true },
  { to: '/dashboard/visitor/applications', label: 'My Applications', icon: FileText },
  { to: '/dashboard/visitor/qr-pass', label: 'QR Pass', icon: QrCode },
  { to: '/dashboard/visitor/profile', label: 'Profile', icon: User },
];

export const VisitorDashboardLayout: FC<{ children: ReactNode }> = ({ children }) => {
