...
const navItems = [
  { to: '/dashboard/host', label: 'My Events', icon: CalendarDays, end: true },
  { to: '/dashboard/host/events/new', label: 'Create Event', icon: PlusCircle },
  { to: '/dashboard/host/visitor-requests', label: 'Visitor Requests', icon: Inbox },
  { to: '/dashboard/host/accepted', label: 'Accepted Visitors', icon: CheckCircle2 },
  { to: '/dashboard/host/rejected', label: 'Rejected Visitors', icon: XCircle },
  { to: '/dashboard/host/attendance', label: 'Attendance', icon: ClipboardList },
  { to: '/dashboard/host/reports', label: 'Reports', icon: BarChart3 },
];

export const HostDashboardLayout: FC<{ children: ReactNode }> = ({ children }) => {
