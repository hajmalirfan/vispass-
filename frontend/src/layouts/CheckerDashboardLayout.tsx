...
import { ScanLine, CalendarCheck, Shield, LogOut, Menu, X } from 'lucide-react';
import { getUser, clearSession } from '../services/api';

const navItems = [
  { to: '/dashboard/checker', label: 'QR Scanner', icon: ScanLine, end: true },
  { to: '/dashboard/checker/today', label: "Today's Entries", icon: CalendarCheck },
];

export const CheckerDashboardLayout: FC<{ children: ReactNode }> = ({ children }) => {
